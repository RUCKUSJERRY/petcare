...
export async function middleware(request: NextRequest) {
  ...
  const protectedPaths = ['/dashboard', '/pets', '/foods', '/health', '/care', '/walk', '/info', '/community', '/profile', '/schedule', '/notifications', '/lost', '/invite', '/costs', '/map', '/premium', '/admin', '/achievements']
