    ...
    <div className="fixed inset-0 z-[70] bg-black/40 flex items-end sm:items-center justify-center" onClick={() => { if (!saving) onClose() }}>
      ...
      >
        <div className="flex items-center justify-between">
          ...
          <button onClick={() => { if (!saving) onClose() }} aria-label={tc('close')} className="relative w-8 h-8 rounded-full bg-gray-100 text-gray-500 before:absolute before:content-[''] before:-inset-1.5">✕</button>
        </div>
